...
(function($) {
    ...
    var settings = {
        ...
        tooltipCss: {
            background: 'rgba(102, 16, 242, 0.70)',
            color: '#fff'
        }
    };
    ...
    var methods = {
        init: function(opts, startFrom) {
            ...
            if (started == false) {
                ...
                controls = '<div id="tourControls" class="d-none">\
        ...
        setTooltip: function(step, stepData, dir) {
            if (options.useOverlay) {
                if (!$overlay) {
                    $overlay = $('<div id="touroverlay" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: '+options.overlayZindex+'; background-color: rgba(0,0,0,0.75);">');
                }
                $('body').append($overlay);
            }
        ...
        getTooltipPosition: function(pos, $e) {
            ...
            $upArrow = $('<div class="tourArrow"></div>').css({ 'position': 'absolute', 'display': 'block', 'width': '0', 'height': '0', 'border-left': '15px solid transparent', 'border-right': '15px solid transparent', 'border-bottom': '15px solid ' + tbg });
            $downArrow = $('<div class="tourArrow"></div>').css({ 'position': 'absolute', 'display': 'block', 'width': '0', 'height': '0', 'border-left': '15px solid transparent', 'border-right': '15px solid transparent', 'border-top': '15px solid ' + tbg });
            $rightArrow = $('<div class="tourArrow"></div>').css({ 'position': 'absolute', 'display': 'block', 'width': '0', 'height': '0', 'border-top': '15px solid transparent', 'border-bottom': '15px solid transparent', 'border-left': '15px solid ' + tbg });
            $leftArrow = $('<div class="tourArrow"></div>').css({ 'position': 'absolute', 'display': 'block', 'width': '0', 'height': '0', 'border-top': '15px solid transparent', 'border-bottom': '15px solid transparent', 'border-right': '15px solid ' + tbg });
            switch (pos) {
                case 'BL':
                    position = { 'left': el, 'top': et + eh + 10 };
                    $upArrow.css({ top: '-15px', left: '48%' });
                ...
                case 'L':
                    ...
                    $rightArrow.css({ top: '15px', right: '-15px' });
                    $tooltip.prepend($rightArrow);
                    break;
                ...
                case 'R':
                    ...
                    $leftArrow.css({ top: th / 2 - 15, left: '-15px' });
                    $tooltip.prepend($leftArrow);
                    break;
            }
            return position;
