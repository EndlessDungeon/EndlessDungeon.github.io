(function($) {
  ...
  var runBossTimer = function(showAnimation=false){
	...
	if(showAnimation){
	  ...
	  componentAction("current-boss-timer","replaceText","("+(restBossTimer/1000)+"/"+(maxBossTimer/1000)+")");
	}
  };
  ...
  var getTowerReward = function(towerId, towerReward, usedKey=1){
	...
	switch(towerId){
	  ...
	  case 4:
		...
		insertNewUnlockEquipment(true,-1,towerRewardArray,false,(towerReward*1));
		break;
	  case 5:
  ...
  var calcTotalOrbs = function (){
	...
	console.log(numberFormat(baseOrbs)+"="+numberFormat(partnerOrbs));
  ...
  $("#buy-tower-plus").on('click', function() {
	let currentValue =  parseInt($("#buy-tower-key").val(),10);
	let availableKey = setting.baseDailyLimitBuyTowerKey - hero.dailyBuyTowerKey;
